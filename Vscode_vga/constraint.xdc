...
## Top module ports:
## sys_clock, sw[0], Hsync, Vsync, vgaRed, vgaGreen, vgaBlue
## ============================================================
...
## ============================================================
## Reset switch
## SW0 is used as active-low reset
## sw[0] = 0 -> reset active
## sw[0] = 1 -> normal operation
## Basys 3 SW0 pin: V17
## ============================================================

#set_property PACKAGE_PIN V17 [get_ports {sw[1]}]
#et_property IOSTANDARD LVCMOS33 [get_ports {sw[0]}]
