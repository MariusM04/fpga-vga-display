...
module tb_vga_top;
    ...
    localparam int half_frame_check_count = 10;           // cate jumatati de frame verifica inainte de reset
    localparam int full_frame_check_count = 20;           // cate frame-uri complete verifica dupa reset / normal
